...
export default function V1BackupPage() {
  ...
  const checarPermissao = () => {
    try {
      ...
      if (salvo) {
        ...
        // Não logado: estritamente bloqueado na V1
        setAutorizado(false);
      }
    } catch {
      setAutorizado(false);
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: "14px", color: "#94a3b8" }}>Carregando Modo de Backup (V1 / Banco Legado)...</div>
        </div>
      </div>
    );
  }
      ...
      >
        ...
        >
          ...
          <h2 style={{ fontSize: "20px", fontWeight: "800", color: "#ef4444", marginBottom: "12px" }}>
            Acesso Restrito ao Backup V1
          </h2>
          <p style={{ fontSize: "13.5px", color: "#cbd5e1", lineHeight: 1.6, marginBottom: "24px" }}>
            A Versão 1 opera sobre o banco de dados legado e está mantida como contingência <strong>exclusivamente para Donos e Administradores</strong>.
            <br /><br />
